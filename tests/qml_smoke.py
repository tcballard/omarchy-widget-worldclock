...
Window {
 ...
 QtObject {id:context;property var settings:'''+json.dumps(fixture)+''';property bool active:false;property string sizeName:"wide"}
 Widget.WorldClock {
  id:clock;anchors.fill:parent;widgetContext:context
...
''')
 ...
 def check():
  ...
  print("PASS: production QML renders six timezone rows with explicit theme/process fixtures")
  app.exit(0)
